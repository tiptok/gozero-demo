...
func (repository *UsersRepository) Save(ctx context.Context, transaction transaction.Trans, dm *domain.Users) (*domain.Users, error) {
	var (
		err error
		m   = &models.Users{}
		tx  = transaction.DB()
...
func (repository *UsersRepository) Remove(ctx context.Context, transaction transaction.Trans, User *domain.Users) (*domain.Users, error) {
	var (
		tx        = transaction.DB()
